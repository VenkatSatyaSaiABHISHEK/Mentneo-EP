    ...
    <div ref={templateRef} className="offer-letter-container">
      ...
      <div className="offer-letter-page">
        ...
        <table className="info-table">
          <tbody>
            ...
            <tr>
              <td className="label">Probation Period</td>
              <td className="colon">:</td>
              <td>{data.probationPeriod}</td>
            </tr>
          </tbody>
        </table>
        ...
        <div className="highlight-box">
          ...
          <div className="content">
            <h4>ACCEPTANCE</h4>
            <p>Please review this offer letter carefully. To confirm your acceptance, kindly sign and return a copy of this letter by {formatDate(data.acceptanceDeadlineDate)}.</p>
          </div>
        </div>
      </div>
      ...
      <div className="offer-letter-page">
        ...
        <div className="terms-list">
          <div className="term-item">
            <div className="term-icon"><Icons.GraduationCap /></div>
            <div className="term-content">
              <h4>3.1 PROBATION AND CONFIRMATION</h4>
              <p>You will be on probation for a period of {data.probationPeriod} from your start date. Your performance and conduct will be reviewed during this period. Upon successful completion of probation, your employment will be confirmed in writing.</p>
            </div>
          </div>
          ...
          <div className="term-item">
            ...
            <div className="term-content">
              <h4>3.2 TRAINING AND ONBOARDING</h4>
              <p>You will undergo an initial training and onboarding program to familiarize yourself with our processes, tools, and policies. The training period is an integral part of your probation and will help you prepare for your role and responsibilities.</p>
            </div>
          </div>
          ...
          <div className="term-item">
            ...
            <div className="term-content">
              <h4>3.3 PERFORMANCE AND EVALUATION</h4>
          ...
          <div className="term-item">
            ...
            <div className="term-content">
              <h4>3.6 INTELLECTUAL PROPERTY</h4>
          ...
          <div className="bottom-split-left">
            ...
            <div>
              ...
              <p style={{ margin: '0', fontSize: '12px', color: '#4B5563', lineHeight: '1.5' }}>
                This offer is valid until {formatDate(data.acceptanceDeadlineDate)}.<br/>
      ...
      <div className="offer-letter-page">
        ...
        <p className="text-body" style={{ marginTop: '20px' }}>
          Please read this offer letter carefully along with all the terms and conditions stated herein. If you accept this offer and the terms of employment, please sign and return a copy of this letter by <span className="text-bold" style={{ color: '#5A4AF4' }}>{formatDate(data.acceptanceDeadlineDate)}</span>.
        </p>
